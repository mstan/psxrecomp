...
/* v22: PGXP load-delay shadow staging/commit/cancel callbacks were appended to
 * PGXPHooks. Overlay code must not expose a staged load to its dependent
 * successor, or a delayed pair can resurrect stale vertex provenance. */
/* (PGXP): OverlayCallbacks grew an appended-last PGXPHooks
 ...
 *  11: + PGXP load-delay staging/commit/cancel callbacks in generated code. */
